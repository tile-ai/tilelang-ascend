...
L0_CASES = [
    ("float16",  (1024, 1024), (128, 128), (-1, 1),       "l0_fp16_basic",
     ["D-DTYPE-fp16", "D-SHAPE-ALIGNED", "D-VALRANGE-S"]),
    ("float32",  (1024, 1024), (128, 128), (-2, 2),       "l0_fp32_basic",
     ["D-DTYPE-fp32", "D-SHAPE-ALIGNED", "D-VALRANGE-S"]),
    ("bfloat16", (1024, 1024), (128, 128), (-3, 3),       "l0_bf16_basic",
     ["D-DTYPE-bf16", "D-SHAPE-ALIGNED", "D-VALRANGE-S"]),
    ("float16",  (2048, 2048), (128, 128), (-10, 10),     "l0_fp16_mid",
     ["D-DTYPE-fp16", "D-SHAPE-ALIGNED", "D-VALRANGE-M"]),
    ("float16",  (1024, 1024), (128, 128), (-65504, 65504), "l0_fp16_maxval",
     ["D-DTYPE-fp16", "D-SHAPE-ALIGNED", "D-SPECIAL-DBOUND"]),
    ("bfloat16", (1024, 1024), (128, 128), "inf",         "l0_bf16_inf",
     ["D-DTYPE-bf16", "D-SHAPE-ALIGNED", "D-SPECIAL-INF"]),
    ("float32",  (1024, 1024), (128, 128), "nan",         "l0_fp32_nan",
     ["D-DTYPE-fp32", "D-SHAPE-ALIGNED", "D-SPECIAL-NAN"]),
    ("float16",  (1024, 1024), (128, 128), (0, 0),        "l0_fp16_zero",
     ["D-DTYPE-fp16", "D-SHAPE-ALIGNED", "D-SPECIAL-ZERO"]),
]
...
L1_CASES = [
    ...
    ((512, 512), "float16", (128, 128), (-10, 10), "l1_fp16_mid",
     ["D-DTYPE-fp16", "D-SHAPE-ALIGNED", "D-VALRANGE-M"]),
    ((512, 512), "float32", (128, 128), (-10, 10), "l1_fp32_mid",
     ["D-DTYPE-fp32", "D-SHAPE-ALIGNED", "D-VALRANGE-M"]),
    ((512, 512), "bfloat16", (128, 128), (-10, 10), "l1_bf16_mid",
     ["D-DTYPE-bf16", "D-SHAPE-ALIGNED", "D-VALRANGE-M"]),
    # D-VALRANGE-L (symmetric large range, near dtype upper bound)
    ((512, 512), "float16", (128, 128), (-65504, 65504), "l1_fp16_large",
     ["D-DTYPE-fp16", "D-SHAPE-ALIGNED", "D-VALRANGE-L", "D-SPECIAL-DBOUND"]),
    ((256, 256), "float32", (128, 128), (-1e4, 1e4), "l1_fp32_large",
     ["D-DTYPE-fp32", "D-SHAPE-ALIGNED", "D-VALRANGE-L"]),
    # D-VALRANGE-ASYM (asymmetric range)
    ((512, 512), "float16", (128, 128), (-5, 10), "l1_fp16_asym",
     ["D-DTYPE-fp16", "D-SHAPE-ALIGNED", "D-VALRANGE-ASYM"]),
    ((512, 512), "bfloat16", (128, 128), (-3, 20), "l1_bf16_asym",
     ["D-DTYPE-bf16", "D-SHAPE-ALIGNED", "D-VALRANGE-ASYM"]),
    # D-SHAPE-EDGE (degenerate: 1×N and N×1)
    ((1, 512), "float16", (128, 128), (-1, 1), "l1_fp16_edge_1xN",
     ["D-DTYPE-fp16", "D-SHAPE-EDGE", "D-VALRANGE-S"]),
    ((512, 1), "float32", (128, 128), (-2, 2), "l1_fp32_edge_Nx1",
     ["D-DTYPE-fp32", "D-SHAPE-EDGE", "D-VALRANGE-S"]),
    # D-SHAPE-TAIL-1 (remainder=1, most likely to expose boundary bugs)
    ((513, 512), "float16", (128, 128), (-1, 1), "l1_fp16_tail1",
     ["D-DTYPE-fp16", "D-SHAPE-TAIL-1", "D-VALRANGE-S"]),
    ((512, 513), "bfloat16", (128, 128), (-3, 3), "l1_bf16_tail1",
     ["D-DTYPE-bf16", "D-SHAPE-TAIL-1", "D-VALRANGE-S"]),
    # D-SHAPE-TAIL-MID (remainder=block_M//2, mid-size tail)
    ((576, 576), "float16", (128, 128), (-1, 1), "l1_fp16_tailmid",
     ["D-DTYPE-fp16", "D-SHAPE-TAIL-MID", "D-VALRANGE-S"]),
    ((576, 512), "float32", (128, 128), (-2, 2), "l1_fp32_tailmid",
     ["D-DTYPE-fp32", "D-SHAPE-TAIL-MID", "D-VALRANGE-S"]),
    # D-SHAPE-PRIME (fully non-aligned, prime dimensions)
    ((509, 503), "bfloat16", (128, 128), (-3, 3), "l1_bf16_prime",
     ["D-DTYPE-bf16", "D-SHAPE-PRIME", "D-VALRANGE-S"]),
    ((509, 503), "float16", (128, 128), (-10, 10), "l1_fp16_prime",
     ["D-DTYPE-fp16", "D-SHAPE-PRIME", "D-VALRANGE-M"]),
]
