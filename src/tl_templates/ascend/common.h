...
CATLASS_DEVICE void TailApplyBinCount(TailVecBinOp op, LocalTensor<T> d,
                                      ...
                                      int32_t n) {
  switch (op) {
  case TailVecBinOp::Add: AscendC::Add(d, s0, s1, n); break;
  case TailVecBinOp::Sub: AscendC::Sub(d, s0, s1, n); break;
  case TailVecBinOp::Mul: AscendC::Mul(d, s0, s1, n); break;
  case TailVecBinOp::Div: AscendC::Div(d, s0, s1, n); break;
  case TailVecBinOp::Max: AscendC::Max(d, s0, s1, n); break;
  case TailVecBinOp::Min: AscendC::Min(d, s0, s1, n); break;
  }
}
...
CATLASS_DEVICE void TailApplyBinMask(TailVecBinOp op, LocalTensor<T> d,
  ...
  switch (op) {
  case TailVecBinOp::Add: AscendC::Add(d, s0, s1, mask, repeat, rp); break;
  case TailVecBinOp::Sub: AscendC::Sub(d, s0, s1, mask, repeat, rp); break;
  case TailVecBinOp::Mul: AscendC::Mul(d, s0, s1, mask, repeat, rp); break;
  case TailVecBinOp::Div: AscendC::Div(d, s0, s1, mask, repeat, rp); break;
  case TailVecBinOp::Max: AscendC::Max(d, s0, s1, mask, repeat, rp); break;
  case TailVecBinOp::Min: AscendC::Min(d, s0, s1, mask, repeat, rp); break;
  }
}
...
CATLASS_DEVICE void TailApplyUnCount(TailVecUnOp op, LocalTensor<T> d,
  ...
  if constexpr (TailIsFloatLike<T>::value) {
    switch (op) {
    case TailVecUnOp::Exp: AscendC::Exp(d, s, n); break;
    case TailVecUnOp::Ln: AscendC::Ln(d, s, n); break;
    case TailVecUnOp::Abs: AscendC::Abs(d, s, n); break;
    case TailVecUnOp::Reciprocal: AscendC::Reciprocal(d, s, n); break;
    case TailVecUnOp::Sqrt: AscendC::Sqrt(d, s, n); break;
    case TailVecUnOp::Rsqrt: AscendC::Rsqrt(d, s, n); break;
    case TailVecUnOp::Relu: AscendC::Relu(d, s, n); break;
    }
  } else {
    switch (op) {
    case TailVecUnOp::Abs: AscendC::Abs(d, s, n); break;
...
CATLASS_DEVICE void TailApplyUnMask(TailVecUnOp op, LocalTensor<T> d,
  ...
  if constexpr (TailIsFloatLike<T>::value) {
    switch (op) {
    case TailVecUnOp::Exp: AscendC::Exp(d, s, mask, repeat, rp); break;
    case TailVecUnOp::Ln: AscendC::Ln(d, s, mask, repeat, rp); break;
    case TailVecUnOp::Abs: AscendC::Abs(d, s, mask, repeat, rp); break;
    case TailVecUnOp::Reciprocal:
      AscendC::Reciprocal(d, s, mask, repeat, rp);
      break;
    case TailVecUnOp::Sqrt: AscendC::Sqrt(d, s, mask, repeat, rp); break;
    case TailVecUnOp::Rsqrt: AscendC::Rsqrt(d, s, mask, repeat, rp); break;
    case TailVecUnOp::Relu: AscendC::Relu(d, s, mask, repeat, rp); break;
    }
  } else {
    switch (op) {
    case TailVecUnOp::Abs: AscendC::Abs(d, s, mask, repeat, rp); break;
...
CATLASS_DEVICE void TailApplyScalarCount(TailVecScalarOp op, LocalTensor<T> d,
  ...
  switch (op) {
  case TailVecScalarOp::Adds: AscendC::Adds(d, s, v, n); break;
  case TailVecScalarOp::Muls: AscendC::Muls(d, s, v, n); break;
  case TailVecScalarOp::Maxs: AscendC::Maxs(d, s, v, n); break;
  case TailVecScalarOp::Mins: AscendC::Mins(d, s, v, n); break;
  }
}
...
CATLASS_DEVICE void TailApplyScalarMask(TailVecScalarOp op, LocalTensor<T> d,
                                        ...
                                        const AscendC::UnaryRepeatParams &rp) {
  switch (op) {
  case TailVecScalarOp::Adds: AscendC::Adds(d, s, v, mask, repeat, rp); break;
  case TailVecScalarOp::Muls: AscendC::Muls(d, s, v, mask, repeat, rp); break;
  case TailVecScalarOp::Maxs: AscendC::Maxs(d, s, v, mask, repeat, rp); break;
  case TailVecScalarOp::Mins: AscendC::Mins(d, s, v, mask, repeat, rp); break;
  }
}
...
CATLASS_DEVICE void tail_reduce_sum(LocalTensor<T> out, LocalTensor<T> src,
  ...
  if (dim == 0) {
    uint32_t r0 = 0;
    if (clear) {
      AscendC::Adds(out, src, static_cast<T>(0), static_cast<int32_t>(validCol));
      r0 = 1;
    }
