...
template <typename T>
CATLASS_DEVICE void mul_mask(const LocalTensor<T> &dst,
                             const LocalTensor<T> &src0,
                             const LocalTensor<T> &src1, const uint64_t mask0,
                             const uint64_t mask1, const uint8_t repeatTime,
                             const uint8_t dstBlkStride,
                             const uint8_t src0BlkStride,
                             const uint8_t src1BlkStride,
                             const uint8_t dstRepStride,
                             const uint8_t src0RepStride,
...
template <typename T>
CATLASS_DEVICE void sub_mask(const LocalTensor<T> &dst,
                             const LocalTensor<T> &src0,
                             const LocalTensor<T> &src1, const uint64_t mask0,
                             const uint64_t mask1, const uint8_t repeatTime,
                             const uint8_t dstBlkStride,
...
template <typename T>
CATLASS_DEVICE void div_mask(const LocalTensor<T> &dst,
                             const LocalTensor<T> &src0,
                             const LocalTensor<T> &src1, const uint64_t mask0,
                             const uint64_t mask1, const uint8_t repeatTime,
                             const uint8_t dstBlkStride,
