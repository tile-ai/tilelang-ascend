...
// tmp buffer is passed from caller, MrgSortExecutedNumList is managed internally
// Each element is a value-index pair: 2 floats per element [value, index]
// ============================================================================

// 2-way merge sort
template <typename T, int32_t SrcCols, int32_t DstCols>
AICORE PTO_INLINE void MergeSort(
    ...
    pto::TMRGSORT<TileUbDataND<T, 1, DstCols, 1, DstCols>,
                  ...
                  TileUbDataND<T, 1, SrcCols, 1, SrcCols>,
                  false>(dst, executedNumList, tmp, src0, src1);
    pipe_barrier(PIPE_V);
}
...
AICORE PTO_INLINE void MergeSort(
    ...
    pto::TMRGSORT<TileUbDataND<T, 1, DstCols, 1, DstCols>,
                  ...
                  TileUbDataND<T, 1, SrcCols, 1, SrcCols>,
                  TileUbDataND<T, 1, SrcCols, 1, SrcCols>,
                  false>(dst, executedNumList, tmp, src0, src1, src2);
    pipe_barrier(PIPE_V);
}
...
AICORE PTO_INLINE void MergeSort(
    ...
    pto::TMRGSORT<TileUbDataND<T, 1, DstCols, 1, DstCols>,
                  ...
                  TileUbDataND<T, 1, SrcCols, 1, SrcCols>,
                  TileUbDataND<T, 1, SrcCols, 1, SrcCols>,
                  false>(dst, executedNumList, tmp, src0, src1, src2, src3);
    pipe_barrier(PIPE_V);
}
