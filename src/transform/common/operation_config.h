...
GetOperationConfig() {
  static std::unordered_map<std::string, OperationConfig> operation_config_ = {
      ...
      {"gemm_v0_mxfp",
       {{{0, "read"}, {1, "read"}, {2, "write"}, {3, "read"}, {4, "read"}},
        "PIPE_M"}},
      {"mma_mx_bias",
       {{{0, "read"}, {1, "read"}, {2, "write"}, {3, "read"}, {4, "read"},
         {5, "read"}},
      ...
      {"tl.ascend_gemm_v1",
       {{{1, "read"}, {2, "read"}, {3, "write"}}, "PIPE_M"}},
      {"tl.ascend_gemm_mx",
       {{{1, "read"}, {2, "read"}, {3, "write"}, {4, "read"}, {5, "read"}},
        "PIPE_M"}},
      {"tl.ascend_mma_mx",
       {{{1, "read"}, {2, "read"}, {3, "write"}, {4, "read"}, {5, "read"}},
        "PIPE_M"}},
      {"tl.ascend_gemm_v0_mxfp",
       {{{1, "read"}, {2, "read"}, {3, "write"}, {4, "read"}, {5, "read"}},
        "PIPE_M"}},
      {"tl.ascend_mma_mx_bias",
       {{{1, "read"}, {2, "read"}, {3, "write"}, {4, "read"}, {5, "read"},
         {6, "read"}},
        "PIPE_M"}},
      {"tl.ascend_gemv_mx",
       {{{1, "read"}, {2, "read"}, {3, "write"}, {4, "read"}, {5, "read"}},
        "PIPE_M"}},
      {"tl.ascend_gemv_mx_acc",
       {{{1, "read"}, {2, "read"}, {3, "write"}, {4, "read"}, {5, "read"},
         {6, "read"}},
        "PIPE_M"}},
      {"tl.ascend_gemv_mx_bias",
       {{{1, "read"}, {2, "read"}, {3, "write"}, {4, "read"}, {5, "read"},
         {6, "read"}},
        "PIPE_M"}},
      {"tl.ascend_tquant",
       {{{1, "write"}, {2, "read"}, {3, "write"}, {4, "write"}, {5, "write"}},
        "PIPE_V"}},
      {"tl.ascend_tdequant",
