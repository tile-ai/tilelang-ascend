...
namespace tl {
  ...
  inline const std::unordered_map<std::string, OperationConfig>& GetOperationConfig() {
    static std::unordered_map<std::string, OperationConfig> operation_config_ = {
      ...
      {"tl.ascend_reduce_max", {{{1, "write"}, {2, "read"}, {3, "write"}}, "PIPE_V"}},
      {"tl.ascend_reduce_min", {{{1, "write"}, {2, "read"}, {3, "write"}}, "PIPE_V"}},
      {"tl.ascend_reduce_sum", {{{1, "write"}, {2, "read"}, {3, "write"}}, "PIPE_V"}},
