...
std::unordered_map<std::string, OperationConfig> operation_config_ = {
  ...
  {"tl.ascend_shmem_ub_get_nbi", {{{0, "write"}, {1, "read"}}, "PIPE_MTE2"}},
  {"tl.ascend_shmem_get_nbi", {{{0, "write"}, {1, "read"}}, "PIPE_MTE3"}},
  {"tl.ascend_shmem_put_nbi", {{{0, "write"}, {1, "read"}}, "PIPE_MTE3"}},
  {"tl.ascend_shmem_ub_put_nbi", {{{0, "read"}, {1, "write"}}, "PIPE_MTE3"}},
