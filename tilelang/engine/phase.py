...
def LowerAndLegalize(mod: IRModule, target: Target) -> IRModule:
    ...
    # Propagate UB tail valid-regions and rewrite supported vector ops, compare,
    # and allow-listed reductions to tail-aware variants (must run before
    # passes that reorder copy/vector ops).
