...
class PassConfigKey(str, Enum):
    ...
    (AscendTailMaskPropagation): rewrites supported vector, compare, and reduce
    ops on a UB tail tile to compute only the valid region. Opt-in so non-tail
    kernels are unaffected. Default: False"""
