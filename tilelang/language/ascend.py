...
def cast_tl(dst: Buffer, src: Buffer, mode: str, count: PrimExpr, scale: Union[float16, float]):
    ...
    if (isinstance(src, int) and src >= 0 and src <= 0xFFFFFFFF) and isinstance(dst, float16):
