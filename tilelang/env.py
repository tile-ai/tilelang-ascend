...
COMPOSABLE_KERNEL_INCLUDE_DIR: str | None = os.environ.get(
    "TL_COMPOSABLE_KERNEL_PATH", None
)
...
TILELANG_CACHE_DIR: str = os.environ.get(
    "TILELANG_CACHE_DIR", os.path.expanduser("~/.tilelang/cache")
)
TILELANG_TMP_DIR: str = os.environ.get(
