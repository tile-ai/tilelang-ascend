...
def vec_add_scalar_2d(M, N, K, block_M, block_N, dtype="float16"):
    m_num = M // block_M
    n_num = N // block_N
    ...
    def main(
        ...
        with T.Kernel(BLOCK_SIZE, is_npu=True) as (cid, _):
            ...
            for i in T.serial(T.ceildiv(m_num*n_num, BLOCK_SIZE)):
                ...
                T.npuir_add(A_VEC, B_Scalar, C_VEC)
                T.copy(C_VEC, C[bx, by])

    return main

def test_vec_add_scalar_2d():
    func = vec_add_scalar_2d(M, N, K, 128, 256)
