module attributes {hivm.module_core_type = #hivm.module_core_type<AIV>, memref.memref_as_ptr} {
  func.func @main(%arg0: i64 {hacc.arg_type = #hacc.arg_type<ffts_base_address>}, %arg1: memref<?xi8> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg2: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg3: memref<?xf16, #hivm.address_space<gm>>, %arg4: memref<?xf16, #hivm.address_space<gm>>, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<AIV>, mix_mode = "aiv"} {
    ...
    %7 = bufferization.to_tensor %subview_1 restrict : memref<4x4xf16, strided<[4, 1]>>
    %inserted_slice = tensor.insert_slice %7 into %5[0, 0] [4, 4] [1, 1] : tensor<4x4xf16> into tensor<4x4xf16>
    %8 = hivm.hir.vcumsum ins(%inserted_slice : tensor<4x4xf16>) outs(%6 : tensor<4x4xf16>) cum_dims = [0] reverse = false -> tensor<4x4xf16>
    %extracted_slice = tensor.extract_slice %8[0, 0] [4, 4] [1, 1] : tensor<4x4xf16> to tensor<4x4xf16>
    %subview_2 = memref.subview %reinterpret_cast_0[0, 0] [4, 4] [1, 1] : memref<4x4xf16, strided<[4, 1]>, #hivm.address_space<gm>> to memref<4x4xf16, strided<[4, 1]>, #hivm.address_space<gm>>
    bufferization.materialize_in_destination %extracted_slice in writable %subview_2 : (tensor<4x4xf16>, memref<4x4xf16, strided<[4, 1]>, #hivm.address_space<gm>>) -> ()
    return
  }
}
