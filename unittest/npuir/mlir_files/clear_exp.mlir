module attributes {hivm.module_core_type = #hivm.module_core_type<AIV>, memref.memref_as_ptr} {
  func.func @main(%arg0: i64 {hacc.arg_type = #hacc.arg_type<ffts_base_address>}, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf16, #hivm.address_space<gm>>, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<AIV>, mix_mode = "aiv"} {
    ...
    %7 = arith.cmpi slt, %6, %c8_i32 : i32
    scf.if %7 {
      %c2_i32 = arith.constant 2 : i32
      %8 = arith.divsi %6, %c2_i32 : i32
      %9 = arith.remsi %6, %c2_i32 : i32
      %c128_i32 = arith.constant 128 : i32
      %10 = arith.muli %8, %c128_i32 : i32
      %c256_i32 = arith.constant 256 : i32
      %11 = arith.muli %9, %c256_i32 : i32
      %12 = arith.index_cast %10 : i32 to index
      %13 = arith.index_cast %11 : i32 to index
      %subview = memref.subview %reinterpret_cast[%12, %13] [128, 256] [1, 1] : memref<512x512xf16, strided<[512, 1]>, #hivm.address_space<gm>> to memref<128x256xf16, strided<[512, 1], offset: ?>, #hivm.address_space<gm>>
      ...
      %14 = arith.sitofp %c0_i32_0 : i32 to f16
      hivm.hir.vbrc ins(%14 : f16) outs(%alloc : memref<128x256xf16, strided<[256, 1]>, #hivm.address_space<ub>>)
      %subview_1 = memref.subview %reinterpret_cast[%12, %13] [128, 256] [1, 1] : memref<512x512xf16, strided<[512, 1]>, #hivm.address_space<gm>> to memref<128x256xf16, strided<[512, 1], offset: ?>, #hivm.address_space<gm>>
      memref.copy %alloc, %subview_1 : memref<128x256xf16, strided<[256, 1]>, #hivm.address_space<ub>> to memref<128x256xf16, strided<[512, 1], offset: ?>, #hivm.address_space<gm>>
    }
    return
  }
}
