module attributes {hivm.module_core_type = #hivm.module_core_type<AIV>, memref.memref_as_ptr} {
  func.func @main(%arg0: i64 {hacc.arg_type = #hacc.arg_type<ffts_base_address>}, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf16, #hivm.address_space<gm>>, %arg4: memref<?xf16, #hivm.address_space<gm>>, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<AIV>, mix_mode = "aiv"} {
    ...
    hivm.hir.vbrc ins(%c1_i32 : i32) outs(%alloc : memref<32x64xi32, strided<[64, 1]>, #hivm.address_space<ub>>)
    %c0_i32 = arith.constant 0 : i32
    %c7_i32 = arith.constant 7 : i32
    %c1_i32_1 = arith.constant 1 : i32
    scf.for %arg11 = %c0_i32 to %c7_i32 step %c1_i32_1  : i32 {
      ...
      %5 = arith.muli %arg11, %c20_i32 : i32
      %6 = arith.addi %5, %4 : i32
      %c8_i32 = arith.constant 8 : i32
      %7 = arith.divsi %6, %c8_i32 : i32
      %8 = arith.remsi %6, %c8_i32 : i32
      ...
      %subview = memref.subview %reinterpret_cast[%11, %12] [32, 64] [1, 1] : memref<512x512xf16, strided<[512, 1]>, #hivm.address_space<gm>> to memref<32x64xf16, strided<[512, 1], offset: ?>, #hivm.address_space<gm>>
      memref.copy %subview, %alloc_2 : memref<32x64xf16, strided<[512, 1], offset: ?>, #hivm.address_space<gm>> to memref<32x64xf16, strided<[64, 1]>, #hivm.address_space<ub>>
      hivm.hir.vgather ins(%alloc_2 : memref<32x64xf16, strided<[64, 1]>, #hivm.address_space<ub>>) indices(%alloc : memref<32x64xi32, strided<[64, 1]>, #hivm.address_space<ub>>) outs(%alloc_3 : memref<32x64xf16, strided<[64, 1]>, #hivm.address_space<ub>>)
      %subview_4 = memref.subview %reinterpret_cast_0[%11, %12] [32, 64] [1, 1] : memref<512x512xf16, strided<[512, 1]>, #hivm.address_space<gm>> to memref<32x64xf16, strided<[512, 1], offset: ?>, #hivm.address_space<gm>>
      memref.copy %alloc_3, %subview_4 : memref<32x64xf16, strided<[64, 1]>, #hivm.address_space<ub>> to memref<32x64xf16, strided<[512, 1], offset: ?>, #hivm.address_space<gm>>
    }
    return
  }
}
