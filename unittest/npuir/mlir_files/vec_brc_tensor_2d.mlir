module attributes {hivm.module_core_type = #hivm.module_core_type<AIV>, memref.memref_as_ptr} {
  func.func @main(%arg0: i64 {hacc.arg_type = #hacc.arg_type<ffts_base_address>}, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf16, #hivm.address_space<gm>>, %arg4: memref<?xf16, #hivm.address_space<gm>>, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<AIV>, mix_mode = "aiv"} {
    ...
    scf.for %arg11 = %c0_i32 to %c2_i32 step %c1_i32_1  : i32 {
      %alloc = memref.alloc() : memref<128x1xf16, strided<[1, 1]>, #hivm.address_space<ub>>
      ...
      %subview = memref.subview %reinterpret_cast[%13, 0] [128, 1] [1, 1] : memref<1024x1xf16, strided<[1, 1]>, #hivm.address_space<gm>> to memref<128x1xf16, strided<[1, 1], offset: ?>, #hivm.address_space<gm>>
      memref.copy %subview, %alloc : memref<128x1xf16, strided<[1, 1], offset: ?>, #hivm.address_space<gm>> to memref<128x1xf16, strided<[1, 1]>, #hivm.address_space<ub>>
      hivm.hir.vbrc ins(%alloc : memref<128x1xf16, strided<[1, 1]>, #hivm.address_space<ub>>) outs(%alloc_2 : memref<128x256xf16, strided<[256, 1]>, #hivm.address_space<ub>>) broadcast_dims = [1]
      %14 = arith.index_cast %12 : i32 to index
      %subview_3 = memref.subview %reinterpret_cast_0[%13, %14] [128, 256] [1, 1] : memref<1024x1024xf16, strided<[1024, 1]>, #hivm.address_space<gm>> to memref<128x256xf16, strided<[1024, 1], offset: ?>, #hivm.address_space<gm>>
      memref.copy %alloc_2, %subview_3 : memref<128x256xf16, strided<[256, 1]>, #hivm.address_space<ub>> to memref<128x256xf16, strided<[1024, 1], offset: ?>, #hivm.address_space<gm>>
    }
    return
  }
}
