...
The following example demonstrates auto-tuning matrix multiplication. Code has been simplified for readability - see `examples_experiment/gemm/example_gemm.py` for complete implementation. 
