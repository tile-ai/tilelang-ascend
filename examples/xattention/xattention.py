                                        ...
                                        if row_pipe >= 1:
                                            ...
                                            for sub_chunk in T.serial(EFFECTIVE_BLOCK_N // SHARED_S_VECTOR_ELEMS):
                                                ...
                                                T.tile.sub_mask(
                                                    ...
                                                    1,
                                                    0,
                                                    EFFECTIVE_BLOCK_N // UB_ALIGN_ELEMS,
                                                    EFFECTIVE_BLOCK_N // UB_ALIGN_ELEMS,
                                                    1,
                                                )
                                            T.tile.exp(
...
if __name__ == "__main__":
    ...
    print(f"  light S/P/O GM slots: S={SHARED_S_SLOTS}, P={SHARED_P_SLOTS}, O={SHARED_O_SLOTS}, taskque={TASKQUE_SLOTS}")
    print(
        "  unshared tasks: "
    ...
    kernel_name = f"xa_v4_direct_unshared_o_{datetime.now().strftime('%Y%m%d_%H%M%S_%f')}.cpp"
