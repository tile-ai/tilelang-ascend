...
def _run_example() -> None:
    source = Path(__file__).with_name("sparse_flash_attn_developer_vid_reduce.py")
    spec = importlib.util.spec_from_file_location("_sparse_flash_attn_developer_vid_reduce_under_test", source)
