...
def test_flash_attn_bhsd_expert_h16_d128_accuracy(q_heads: int, kv_heads: int) -> None:
    ...
    # The second case exercises the grouped path, which is where the expert
    # variant's manual synchronisation has the most to get wrong.
    _run_example(
        "--B",
        "1",
        "--S",
