...
def mtgr_ragged_segment_attention_fwd_pa(
    ...
    def main(
        ...
        K: T.Tensor([total_live_q, kv_heads, dim], dtype),
        V: T.Tensor([total_live_q, kv_heads, dim], dtype),
            ...
            for core_index in T.serial(my_iters):
                ...
                for s_local in T.serial(q_tiles_b):
                    ...
                    for k_i in T.serial(kv_tiles_b):
                        ...
                        # Padding rows: not filled, masked out by valid_cols in softmax
                        ...
                        if tile_live_len > 0:
                            ...
                            T.copy(
                                ...
                                v_l1[tile_cache_len : tile_cache_len + tile_live_len, :],
                            )
                        # Padding rows: not filled, masked out
...
if __name__ == "__main__":
    ...
    seg_lengths = [[64, 8, 32, 24], [128, 8, 32, 64]]
    rules = [0, 1, 0, 2]
