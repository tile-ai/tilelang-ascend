...
@tilelang.jit(out_idx=[-1], workspace_idx=[-3], pass_configs=pass_configs)  # for jit
    ...
    def main(
        ...
        with T.Kernel(B * N2, is_npu=True) as (cid, vid):
            ...
            with T.Scope("V"):
                ...
                # Use MAX_S2 for buffer sizes since S2 is dynamic
