...
def _check_precision(actual, golden):
    ...
    if not (a.is_floating_point() or g.is_floating_point()):
        ...
        return
    table = {
        "torch.float16": (1e-3, 1e-3, float("inf")),
        "torch.bfloat16": (1e-3, 1e-3, float("inf")),
        "torch.float32": (1e-3, 1e-3, float("inf")),
        "hifloat32": (1e-3, 1e-3, float("inf")),
        "float8_e4m3": (1e-3, 1e-3, float("inf")),
        "float8_e5m2": (1e-3, 1e-3, float("inf")),
    }
    name = str(g.dtype)
