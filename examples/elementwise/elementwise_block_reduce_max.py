    ...
    def main(
        ...
        with T.Kernel(m_num * n_num, is_npu=True) as (cid, vid):
            ...
            with T.Scope("V"):
                ...
                T.barrier_all()
                T.block_reduce_max(b_ub, a_ub, repeat, mask, dstRepStride, srcBlkStride, srcRepStride)
                T.barrier_all()
...
func = block_reduce_max(M, N, block_M, block_N, repeat, mask, dstRepStride, srcBlkStride, srcRepStride, dataBlockHalfNum)
