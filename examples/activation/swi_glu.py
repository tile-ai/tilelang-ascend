...
def swi_glu(M, N, block_M, block_N, dtype="float"):
    ...
    def main(
        ...
        with T.Kernel(m_num * n_num, is_npu=True) as (cid, vid):
            ...
            ta0_ub = T.alloc_ub((block_M // VEC_NUM, 36), dtype)    
            ta1_ub = T.alloc_ub((block_M // VEC_NUM, 36), dtype)
            tb_ub = T.alloc_ub((block_M // VEC_NUM, 36), dtype)
            tzero_ub = T.alloc_ub((block_M // VEC_NUM, 36), dtype)
            ttemp_ub = T.alloc_ub((block_M // VEC_NUM, 36), dtype)
