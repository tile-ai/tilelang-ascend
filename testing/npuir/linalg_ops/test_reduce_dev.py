...
def vec_reduce_3d_to_2d_any(M, K, N, dtype="int32"):
    @T.prim_func
...
def vec_reduce_3d_to_2d_all(M, K, N, dtype="int32"):
    @T.prim_func
...
def vec_reduce_3d_to_2d_xori(M, K, N, dtype="int32"):
    @T.prim_func
...
def vec_reduce_3d_to_2d_ori(M, K, N, dtype="int32"):
    @T.prim_func
