...
parser.add_argument("--block_M", type=int, default=64, help="")
parser.add_argument("--block_N", type=int, default=64, help="")
        ...
        with T.Kernel(BLOCK_SIZE, is_npu=True) as (cid, _):
            ...
            for i in T.serial(T.ceildiv(m_num*n_num, BLOCK_SIZE)):
                ...
                if block_id < m_num * n_num:
                    ...
                    T.npuir_brc(i, A_VEC)
                    # T.npuir_brc(B_VEC[bx,by], A_VEC)
                    # T.npuir_fill(A_VEC, i)
                    # T.npuir_fill(A_VEC, bx)
